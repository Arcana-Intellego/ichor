...
_BLOCK_MENUS_BY_LABEL = {
    ...
    "Edit diversity resources": _make_block_menu(
        "Edit Diversity Resources",
        "ICHOR diversity overrides; null values inherit from resource defaults.",
        [
            _spec("resources.diversity.partition", "optional_str"),
            _spec("resources.diversity.walltime_hours", "optional_float"),
            _spec("resources.diversity.cpus_per_task", "optional_str", transform=_auto_or_int, prompt="resources.diversity.cpus_per_task (null, auto, or positive integer): "),
            _spec("resources.diversity.mem_per_cpu", "optional_str", prompt="resources.diversity.mem_per_cpu (null, auto, or SLURM style, e.g. 4G): "),
            _spec("resources.diversity.auto_max_workers", "int"),
            _spec("resources.diversity.target_pairs_per_worker", "int"),
            _spec("resources.diversity.in_memory_distance_store_fraction", "float"),
        ],
    ),
    ...
    "Edit FEREBUS block": _make_block_menu(
        ...
        [
            _spec(
                "ferebus.kernel",
                "choice",
                choices=sorted(VALID_FEREBUS_KERNELS),
            ),
            ...
            _spec(
                ...
                "choice",
                choices=sorted(VALID_FEREBUS_PRIOR_MEAN_STRATEGIES),
            ),
            _spec(
            ...
            _spec("ferebus.physical_prior_scale", "float"),
    ...
    "Edit acquisition.calibrated_energy": _make_block_menu(
        ...
        [
            ...
            _spec("acquisition.calibrated_energy.band_low_ha_per_sqrt_atom", "optional_float"),
            _spec("acquisition.calibrated_energy.band_high_ha_per_sqrt_atom", "optional_float"),
            _spec("acquisition.calibrated_energy.low_softness_ha_per_sqrt_atom", "optional_float"),
            _spec("acquisition.calibrated_energy.high_softness_ha_per_sqrt_atom", "optional_float"),
    ...
    "Edit adversarial_safety": _make_block_menu(
        ...
        [
            ...
            _spec("adversarial_safety.under_move_retry_max", "int"),
        ],
    ),
...
edit_campaign_config_menu_items = [
    ...
    _block_submenu_item("Edit diversity resources"),
